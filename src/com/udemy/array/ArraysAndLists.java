...
/*
 * arrays created using toArray method will not update on list update or vice versa.
 */
public class ArraysAndLists {
    public static void main(String[] args) {
        ...
        nextArray[0] = "saurabh";//change in array will not reflect in List from where array created.
