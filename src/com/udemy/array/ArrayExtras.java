...
public class ArrayExtras {
    public static void main(String[] args) {
        ...
        /*
         * cannot assign int array to long or Integer type reference.
         */
//        Long[] newLongArray = new int[2];
//        Integer[] newIntegerArray = new int[2];

        /*
         * methods of Arrays class will not accept int and Integer array for comparison.
         */
...
//        int compared = Arrays.compare(intArray, integerArray);
        ...
        /*
         * Number class haven't implemented the Comparable interface so will not work in compare method.
         */
